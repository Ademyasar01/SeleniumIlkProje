...
public class Day02_DriverOdev {
    ...
    public static void main(String[] args) {
       ...
       /*
        ...
        System.out.println("Title : " + sayfaTitle);
        webDriver.navigate().to("http://youtube.com");
        String sayfaTitl = webDriver.getTitle();
        System.out.println("Title : " + sayfaTitl);
        String sayfaUrle = webDriver.getCurrentUrl();
        System.out.println("Url : "+ sayfaUrle);
        webDriver.navigate().back();
        String sayfaUrl = webDriver.getCurrentUrl();
        System.out.println("Url : "+ sayfaUrl);
        webDriver.quit();
        */
